...
#include "ga_stt/controller_ga_stt.h"
...
static ControllerFcns controllerFunctions[] = {
  ...
  {.init = controllerGaSttInit, .test = controllerGaSttTest, .update = controllerGaStt, .name = "GA-STT"},
...
void controllerInit(ControllerType controller) {
  ...
  if (selectedController == ControllerTypeAutoSelect) {
    ...
    #elif defined(CONFIG_CONTROLLER_GA_STT) 
        selectedController = ControllerTypeGA_STT;
